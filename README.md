...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=42275a,734b6d&height=200&section=header&text=Lend&fontSize=70&fontColor=ffffff&animation=twinkling" width="100%" />
...
**Lend** is a classification app scaffold: it trains a scikit-learn/XGBoost model on a
...
```cmd
git clone https://github.com/AfnanSharif/Lend.git
cd Lend
